...
export const appRoutes: Route[] = [
  ...
  },
  {
    path: 'admin-campaign',
    loadComponent: () =>
      import('./admin-campaign/admin-campaign.component').then((m) => m.AdminCampaignComponent),
      canActivate: [canActivateWithRole(UserType.Admin)]
  },
  {
    path: 'employee',
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./employee-campaign/employee-campaign.component').then((m) => m.EmployeeCampaignComponent),
      canActivate: [canActivateWithRole(UserType.Employee)]
